...
EOT,
    ...
    {
        return [
            'ITILCategory', 'KnowbaseCategory', 'TaskCategory', 'RequestType', 'EventCategory',
            'USBVendor', 'PCIVendor', 'DenyList', 'DeniedMailContent', 'CloseTime',
            ...
            'OperatingSystemKernelVersion', 'AutoUpdateSystem', 'FollowupTemplate',
