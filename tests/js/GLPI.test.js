...
describe('GLPI Core Module', () => {
    ...
    test('Core modules auto-registered', () => {
    ...
    test('Redefine Alert', () => {
        ...
        window.glpi_alert = jest.fn();
        window.alert('test', 'test caption');
        expect(window.glpi_alert).toHaveBeenCalledWith({
            message: 'test',
            title: 'test caption',
        });
    });
    ...
    test('Redefine Confirm', () => {
        ...
        window.glpi_confirm = jest.fn();
        window.confirm('test', 'test caption');
        expect(window.glpi_confirm).toHaveBeenCalledWith(
