...
class KnowbaseControllerTest extends HLAPITestCase
{
    ...
    public function testDeprecatedCategories()
    {
        ...
        $this->api->withVersion('2.3.0')->call($request, function ($call) use ($articles) {
            $call->response
                ->isOK()
        ...
        $this->api->withVersion('2.3.0')->call(new Request('GET', '/Knowledgebase/Category/' . $articles['middle']->getID()), function ($call) use ($articles) {
            $call->response
                ->isOK()
                ->jsonContent(function ($content) use ($articles) {
        ...
        $this->api->withVersion('2.3.0')->call(new Request('GET', '/Knowledgebase/Category/' . $articles['leaf']->getID()), function ($call) {
