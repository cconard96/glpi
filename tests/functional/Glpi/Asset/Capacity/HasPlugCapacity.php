...
class HasPlugCapacity extends DbTestCase
{
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->object(\Item_Plug::getById($av_item_1->getID()))->isInstanceOf(\Item_Plug::class);
        $this->integer(countElementsInTable(Log::getTable(), $item_1_logs_criteria))->isEqualTo(2); //create + add plug
        $this->object(\Item_Plug::getById($av_item_2->getID()))->isInstanceOf(\Item_Plug::class);
        ...
        $this->boolean(\Item_Plug::getById($av_item_1->getID()))->isFalse();
